...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div>
      ...
      >
        <div className="overlay absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-70 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          <Link
            href={gitUrl}
      ...
      <div className="text-white rounded-b-xl mt-1 bg-[#181818] py-6 px-4">
        <h5 className="font- font-semibold mb-2">{title}</h5>
